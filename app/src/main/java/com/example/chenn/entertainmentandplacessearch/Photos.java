...
public class Photos extends Fragment {
    ...
    public void onResume(){
        ...
        //LinearLayout linearLayouta = (LinearLayout) getActivity().findViewById(R.id.linearLayout1);

        //if(((LinearLayout) linearLayouta).getChildCount() > 0)
         //   ((LinearLayout) linearLayouta).removeAllViews();
