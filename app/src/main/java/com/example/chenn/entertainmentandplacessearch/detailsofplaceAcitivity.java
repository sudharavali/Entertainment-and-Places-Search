...
public class detailsofplaceAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        formattedAddress = getIntent().getStringExtra("faddress");
    ...
    public void addTwitterActionListener(){
        ...
        twitter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String str = "https://twitter.com/intent/tweet?text=Check out "+name+" at "+formattedAddress+" Website: &url=" +website ;
